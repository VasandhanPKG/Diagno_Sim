          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate("/dashboard")}
                className="group w-full bg-slate-900 text-white py-5 rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-slate-800 transition-all duration-300 flex items-center justify-center gap-3 shadow-xl shadow-slate-200 print:hidden"
              >
                Return to Dashboard
